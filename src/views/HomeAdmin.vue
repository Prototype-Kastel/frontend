            ...
            <div class="col-xl-3 col-md-6">
              <div class="card card-stats">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Room Type</h5>
                  ...
                  <p class="mt-3 mb-0 text-sm">
                    <span class="text-nowrap">Total Room Type</span>
                  </p>
                </div>
              </div>
            </div>
            <div class="col-xl-3 col-md-6">
              <div class="card card-stats">
                ...
                <div class="card-body">
                  ...
                  <p class="mt-3 mb-0 text-sm">
                    <span class="text-nowrap">Total Jumlah Room</span>
                  </p>
                </div>
              </div>
            </div>
            <div class="col-xl-3 col-md-6">
              <div class="card card-stats">
                ...
                <div class="card-body">
                  ...
                  <p class="mt-3 mb-0 text-sm">
                    <span class="text-nowrap">Total jumlah booking</span>
                  </p>
                </div>
              </div>
            </div>
