            ...
            <div class="card-body">
              ...
              <div class="row">
                        ...
                        <div class="row">
                          ...
                          <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" v-model="booking.idcard_type" readonly>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <label for="">ID Card Number</label>
                                <input type="text" class="form-control" v-model="booking.idcard_number" readonly>
                            </div>
                           </div>
                         <div class="form-group">
                             <label for="">ID Card Photo</label> <br>
                             <img :src="booking.idcard_photo" alt="" height="200ox" width="200px" >
                         </div>
                ...
                <!-- Card body -->
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            ...
                            <div class="col">
                                <h5 class="card-title text-uppercase text-muted mb-0">Less Cost</h5>
                                <span class="h2 font-weight-bold mb-0 text-danger">Rp.{{ new Intl.NumberFormat().format(booking.less_cost) }} </span> 
                            </div>
                    ...
                    <div class="card">
                      <div class="card-header">Verifikasi Check In</div>
                      <div class="card-body">
                        <form @submit.prevent="editCheckin()">
                        <div class="form-group">
                            <label for="">Check In At</label>
                            <input type="date" class="form-control" v-model="booking.check_in_at">
                        </div>
                         <div class=" form-group  ">
                ...
                <div class="card-body">
                   <label for="">Tambah Pesanan Kamar</label>
                    <div class="form-group" style="float: right">
                          <router-link :to=" this.booking.id + '/addcheckinRoom'"><span class="btn btn-primary btn-sm mb--2"><i class="fas fa-plus"></i> Tambah Data</span></router-link> 
                    </div>
              ...
              <div class="card">
                  <div class="card-body">
                     <label for="">Tambah Tamu</label>
                      <div class="form-group" style="float: right">
                        <router-link :to=" this.booking.id + '/addcheckincustomer'"><span class="btn btn-primary btn-sm mb--2"><i class="fas fa-plus"></i> Tambah
...
export default {
  ...
  methods: {
     ...
     deleteRoom(id,index,roomtype_id){
       ...
       async editCheckin(){
           let fd = new FormData();
           fd.append('check_in_at',this.booking.check_in_at);

            try {
                let response = await axios.post(`api/checkin/edit/${this.$route.params.id}`,fd);
                if(response.status == 200){
                    this.loading = false;
                    createToast('data berhasil dihapus',
                            {
