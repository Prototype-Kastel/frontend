      ...
      <div class="col-md-8">
        <div class="card">
          ...
          <div class="card-header">
            <h3 class="mb-0">Add Room Status</h3>
          </div>
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <select name="" id="" class="form-control">
                <option value="">Vacant Clean</option>
                <option value="">Vacant Dirty</option>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="form-group">
              ...
              <input type="text" class="form-control" value="Medium" />
            </div>
            <div class="form-group">
              <label for="">No Room</label>
              <input type="text" class="form-control" value="B17" />
            </div>
            <div class="form-group">
